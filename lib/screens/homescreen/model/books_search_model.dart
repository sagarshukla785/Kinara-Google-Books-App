...
BookSearchModel bookSearchModelFromJson(String str) => BookSearchModel.fromJson(json.decode(str));

String bookSearchModelToJson(BookSearchModel data) => json.encode(data.toJson());
...
class SaleInfoListPrice {
    ...
    factory SaleInfoListPrice.fromJson(Map<String, dynamic> json) => SaleInfoListPrice(
        ...
        currencyCode: json["currencyCode"] == null ? null : currencyCodeValues.map![json["currencyCode"]],
    );

    Map<String, dynamic> toJson() => {
        "amount": amount == null ? null : amount,
        "currencyCode": currencyCode == null ? null : currencyCodeValues.reverse[currencyCode],
    };
}
